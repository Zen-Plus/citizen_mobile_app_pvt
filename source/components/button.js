...
export const Button = ({
  ...
  <PreventDoubleClickWithOpacity onPress={onPress} disabled={disabled} {...props} activeOpacity={0.8}>
    <View
      style={[
        styles.container,
        primary
          ...
          : {
              backgroundColor: 'transparent',
              borderWidth: 1,
              borderColor: basicBorderColor ? basicBorderColor : colors.gray900,
            },
        disabled && !loading
          ? {
              backgroundColor: primary
                ? chroma(backgroundColor).desaturate(1).luminance(0.5).hex()
                : 'transparent',
      ...
      {loading ? (
        <ActivityIndicator
          color={
            primary ? colors.gray50 : color || colors.gray900
          }></ActivityIndicator>
      ) : title ? (
        <Text
          style={[
            ...
            disabled
              ? {
                  color: primary
                    ? colors.gray200
                    : chroma(colors.gray900).desaturate(2).luminance(0.5).hex(),
                }
              : {},
